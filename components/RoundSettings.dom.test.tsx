...
describe('RoundSettings', () => {
  it('offers exactly 5, 10 and 20, and reports a change', () => {
    ...
    render(<RoundSettings value={{ count: 10, mix: 'mieszane', level: 'zaawansowany' }} onChange={onChange} />)
  ...
  it('switches the mix, marking the current one', () => {
    const onChange = vi.fn()
    render(<RoundSettings value={{ count: 10, mix: 'slowa', level: 'zaawansowany' }} onChange={onChange} />)
